...
import OrderDetails from "@/components/ui/cart/OrderDetails";
import Payment from "@/components/ui/cart/Payment";
...
function ShoppingCartPage() {
    return (
        <div className="p-2 flex flex-col w-full">
            ...
            <div
                className="flex flex-wrap xs:flex-col sm:flex-col md:flex-col lg:flex-row justify-center items-center pt-10">
                <CartItems/>
                <OrderDetails/>
                <Payment/>
            </div>
