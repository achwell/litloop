...
import {ArchiveBoxIcon, ArchiveBoxXMarkIcon, CurrencyEuroIcon} from "@heroicons/react/24/solid";
import Link from "next/link";
import AddToCart from "@/components/ui/books/AddToCart";
        ...
        <div className="flex flex-col items-center rounded-xl bg-gray-50 p-2 m-2 shadow-sm">
            ...
            <div className="flex flex-col justify-around truncate rounded-xl bg-white px-4 py-8 w-full text-xs">
                <div className="flex justify-around">
                    ...
                    <div className="flex">
                        <CurrencyEuroIcon className="w-5 mr-0.5"/>
